...
<!--changes by rutuja-->
<td colsapn="1"><b>Manager :</b>&nbsp;&nbsp;<?php if($u->isHR()){      
echo ucwords($manager_name = $u->getMyManager($user_details['empno']));}
 else {
   echo ucwords($manager_name = $u->getMyManager($user_details['empno']));
}?></td>
...
<br />
        <table  class="adminlist" cellpadding="4" width="100%">
<tr>
<th class="title" width="10%">Type of Leave</th>
<th class="title" width="10%" >Leaves for Current Year</th>
<th class="title" width="10%" >Carried Forward Leaves</th>
<th class="title" width="10%" >Total available</th>
<th class="title" width="10%" >Leaves Taken</th>
<th class="title" width="10%" >Balance Leaves</th>
<?php 	$format = "Y-m-d";
...
<th class="title" width="10%" >Application Date</th>
<th class="title" width="15%" >Date of Holiday Working</th>
<th class="title" width="15%" >Date of Comp. Off to be taken</th>
...
<img src="images/calendar-Icon.gif" onclick="return showCalendar('sel4', 'y-mm-dd');"> <?php } else{ echo "&nbsp;"; }  echo "</td>
	...
	<td>";
	if($c_o['status'] != 'Cancelled' && $c_o['compoff_cancelled'] != 1){ 
